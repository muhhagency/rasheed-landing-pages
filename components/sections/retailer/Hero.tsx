...
import { HERO } from "@/content/retailer";
        ...
        <div className="b2b-hero__grid">
          <div className="b2b-hero__copy">
            ...
            {/* Sign Up / Log in are TEMPORARILY replaced by Contact us + phone:
                /signup does not exist and the retailer portal is not live. The
                ...
                <div className="b2b-hero__actions">
                  ...
                  <Button
                    variant="secondary"
                    size="lg"
                    href="https://retailers.rasheedapp.com"
                  >
                    Log in
                  </Button>
                </div>
          ...
          <div className="b2b-hero__media">
            <ResponsiveImage
              asset={IMAGES.retailerHero}
              alt="A customer tapping their phone on a TapCeipt device at a retail checkout"
